...
public class Servlet_Venta extends HttpServlet {
    ...
    private void RegistrarVenta(HttpServletRequest request, HttpServletResponse response)
        ...
        v.setMascota(request.getParameter("txtMascota"));
        ...
        if(resp){
            ...
            String FechaInicio[] = request.getParameterValues("FechaInicio");
            String FechaFin[] = request.getParameterValues("FechaFin");
            ...
            for(int i=0; i<NombreProducto.length;i++){
                try{
                    ...
                    cs.setString(7, FechaInicio[i]);
                    cs.setString(8, FechaFin[i]);
    ...
    private void MostrarDetalleVenta(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("FechaVenta", request.getParameter("FechaV"));
         request.getSession().setAttribute("FechaInicio", request.getParameter("FechaI"));
          request.getSession().setAttribute("FechaFin", request.getParameter("FechaF"));
       request.getSession().setAttribute("Mascota", request.getParameter("MascotaC"));
