            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <table class="table-bordered table pull-right" id="mytable" cellspacing="0" style="width: 100%;">
                        ...
                        <%
                            ArrayList<Mascota> lista = Mascota_DB.obtenerMascotasInhabilitados();
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td >
                                    <input type="button" name="btnRecuperar" id="btnRecuperar" class="button btn btn-outline-info" value="Recuperar" onclick="location.href = 'Servlet_Mas?CodigoM=<%=m.getCodigoM()%>&&accion=recuperar'">
                                </td>
                            </tr>
